...
ARG CUDA_IMAGE=nvidia/cuda:13.2.0-devel-ubuntu22.04
FROM ${CUDA_IMAGE}
...
LABEL io.armmeh.target.device="Jetson Orin Nano" \
      io.armmeh.target.jetpack="7.2" \
      io.armmeh.target.l4t="39.2.0" \
      io.armmeh.target.cuda="13.2"
